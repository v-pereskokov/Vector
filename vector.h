...
//    class iterator;
    ...
    public:
        ...
        /******************************************************************
         * Меняет все свойства вектора 'other' на нынешние свойтсва вектора
         */
        ...
        /********************************************************
         * Освобождение вектора от лишних ячеек, под которые выделена память, 
         * но они не заполнены значениями
         */
